# -*- coding: utf-8 -*-
"""
Created on Mon Sep 28 09:49:59 2020
...
if __name__ == '__main__':
    ...
    dbIn = 'D:/Dropbox/trabajo/FaST_2020/Data/BD/PTOS_BD_Suelos_CyL_new.sqlite'
    ...
    sqlSentence = "SELECT ID, COOR_X_ETRS89, COOR_Y_ETRS89, ASTEXT(Geometry) AS GEO_WKT FROM PTOS_INTERPOLAR"
...
# =============================================================================
    ...
    gpd_ptos.drop(['GEO_WKT'], axis = 1).to_sql('LOCATION_COVARIANTS', conn, if_exists='replace', index=False)
    #
